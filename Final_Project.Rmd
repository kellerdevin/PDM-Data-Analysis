...
Barchart <-ggplot(data=coeffMag, aes(x=Variables, y=count, fill=Variables))+
  geom_bar(stat="identity") + theme(text = element_text(size = 25)) + ggtitle("Count of True Values")
...
Barchart <-ggplot(data=coeffMag, aes(x=Variables, y=ratio, fill=Variables))+
  geom_bar(stat="identity") + theme(text = element_text(size = 25)) + ggtitle("Ratio of Trues and Falses")
